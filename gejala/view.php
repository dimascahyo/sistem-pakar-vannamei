<?php
    ...
    $sql_read = "SELECT g.id_gejala, g.nama_gejala
                FROM gejala g
                ";
...
<body>
    ...
    <div id="container">
        ...
        <a href="create.php" class="button" id="add">Tambah Gejala</a>
        <br><br>
        <table>
            <thead>
                <tr>
                ...
                <?php
                        if ($result_read->num_rows > 0) {
                            while ($row = $result_read->fetch_assoc()) {
                                ...
                                echo "<td><a href='edit.php?id=".$row['id_gejala']."' class='button'>Edit</a>
                                    <a href='delete.php?id=".$row['id_gejala']."' class='button' id='delete'>delete </a></td>
                                ";
                                echo "</tr>";
                            }
                        } else {
