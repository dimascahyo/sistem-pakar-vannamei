...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT g.id_gejala, g.nama_gejala
              FROM gejala g
              WHERE g.id_gejala = $id_gejala";
...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="proses-edit.php">
            ID Gejala: <input type="text" name="id_gejala" value="<?php echo $id_gejala; ?>" readonly><br><br>
            Keterangan: <input type="text" name="nama_gejala" value="<?php echo $nama_gejala; ?>"><br><br>
